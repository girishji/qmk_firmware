...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        OSM(MOD_LCTL), KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT, KC_QUOT, KC_RIGHT,
        LALT(KC_C), OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_RSFT), KC_UP,
        CMD_GRV, OSM(MOD_LALT), KC_BTN1, OSL(_FN), OSM(MOD_LGUI), KC_SPC, KC_GRV, KC_BSPC, KC_PGDN, KC_PGUP, RCTL(KC_T), OSM(MOD_RALT), KC_LEFT, KC_DOWN
    ),
    [_FN]   = LAYOUT(
        ...
        QK_BOOT, _______, KC_BTN3, _______, _______, _______, LED_MATRIX_TOGGLE, LALT(KC_BSPC), KC_END, KC_HOME, _______, _______, BL_UP, BL_DOWN
    ),
    [_LAYER2]   = LAYOUT(
