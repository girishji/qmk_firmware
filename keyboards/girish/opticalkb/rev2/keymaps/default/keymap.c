...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN]   = LAYOUT(
        ...
        _______, DYN_REC_STOP, _______, DYN_MACRO_PLAY1, _______, _______, _______, _______, LGUI(KC_LEFT), LGUI(KC_RIGHT), KC_PGUP, _______, _______, _______, 
        ...
        RESET, KC_BTN3, _______, _______, _______, _______, _______, LALT(KC_BSPC), KC_END, KC_HOME, _______, KC_WH_D, KC_WH_U, _______ 
    ),
    [_LAYER2]   = LAYOUT(
        _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_HOME, KC_END,
        ...
        RESET, _______, _______, _______, _______, _______, _______, _______, KC_END, KC_HOME, _______, _______, _______, _______
    )
};
