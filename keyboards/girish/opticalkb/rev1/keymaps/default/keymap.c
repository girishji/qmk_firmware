...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        OSM(MOD_LSFT), OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_RSFT), KC_HOME, KC_END,
        OSM(MOD_LALT), KC_BTN1, CMD_GRV, OSL(_FN), OSM(MOD_LGUI), KC_SPC, KC_GRV, KC_BSPC, RGUI_T(KC_PGDN), KC_PGUP, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_CAPS
    ),
    [_FN]   = LAYOUT(
    ...
    [_LAYER2]   = LAYOUT(
        ...
        RESET, _______, _______, _______, _______, _______, _______, _______, KC_END, KC_HOME, _______, _______, _______, _______, _______
    )
};
